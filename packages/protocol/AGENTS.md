...
- The current release identity is `0.13.0`; `schemaVersion` is `7`.
- Runtime v7 rejects v6. Extension and Host upgrades or rollbacks must be synchronous; do not add
  an implicit compatibility layer.
- Wire v7 health results identify exactly one
