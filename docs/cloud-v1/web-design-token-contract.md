...
> 历史契约说明：本文件保留 Phase 44 的静态 Token 闭包与可执行属性边界。2026-09-02 起，其中“单一
> 皮肤”“不新增运行时主题”和“不改变视觉尺寸”不再是当前产品约束；四外观及布局的生产权威为
> `seen-said-ui-design-system.md`，静态闭包继续适用于每套 semantic registry。
