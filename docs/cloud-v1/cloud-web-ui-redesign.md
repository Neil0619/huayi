...
> 历史设计说明：本文件保留 2026-08-24 已交付 UI 的结构与部署证据。2026-09-02 起，暖色“纸上
> 语言馆”的配色、侧栏和有限 elevation 方向已由经批准的
> `seen-said-ui-design-system.md` 取代；路由、权限、默认 `/practice`、业务状态机和内容优先原则继续
> 有效。
