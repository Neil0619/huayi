...
- Windows：DeepSeek-only，不连接本机 Codex，不启用欧路或其他 Provider
...
| 0.10    | Windows DeepSeek-only Host、DPAPI 凭据、SEA 可执行文件和 Chrome 注册表 |

## 仍然不支持

- Windows 上的 Codex、OpenAI、Compatible HTTP 和欧路生词本。
