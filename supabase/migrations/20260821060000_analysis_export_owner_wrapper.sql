...
CREATE OR REPLACE FUNCTION huayi_private.owner_analysis_public_record(
...
REVOKE ALL ON FUNCTION huayi_private.analysis_public_record(uuid)
  FROM PUBLIC, huayi_business, huayi_context_setter;
