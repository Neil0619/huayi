...
interface SubtitleShortcutOptions {
  readonly canHold: () => boolean;
  readonly setHolding: (holding: boolean) => void;
  readonly shortcut: StoreKeyboardShortcut | null;
}

export function formatSubtitleShortcutLabel(shortcut: StoreKeyboardShortcut | null): string {
...
export class SubtitleShortcutController {
  private claimed = false;

  constructor(
    private readonly documentRef: Document,
    private readonly options: SubtitleShortcutOptions,
  ) {}
