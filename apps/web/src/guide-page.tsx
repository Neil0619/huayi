      ...
      <div className="site-guide-layout">
        ...
        <div className="site-guide-content">
          ...
          <section id="wechat">
            ...
            <h3>已经有网页学习记录</h3>
            <p>
              在首次开通时选择“关联已有语见账号”。打开已登录的网页，在“账号与额度 →
              微信小程序关联”输入小程序提供的一次性绑定码，完成近期身份验证与共用数据确认，再回小程序完成开通。
            </p>
            <p>
              关联后两端共用学习数据与额度。首版不合并两个独立账号的记录；如果想沿用网页数据，请在直接开通之前选择关联。
            </p>
            <p>绑定码过期时重新获取即可。你也可以返回开通方式，改选独立使用。</p>
          </section>
          <section id="browser">
            ...
            <p>
              插件与小程序使用不同的配对/关联流程。微信绑定码应在网页的“微信小程序关联”区域填写。
            </p>
          </section>
