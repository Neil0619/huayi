...
在普通 YouTube `/watch` 视频中开启英文字幕，点击 CC 按钮旁的“译”。Huayi 会用页面已经
渲染的字幕片段组装当前英文句：点击后立即显示已取得的内容，播放中的视频最多继续 2.5 秒以
补齐句尾，然后暂停并开放点词、连续短语拖选和“整句字幕”。再次点击“译”、关闭或按 Escape
后，只恢复由 Huayi 主动暂停的视频。原本暂停的视频不会为了补字幕自动播放；直播、Shorts、
transcript 和字幕历史不受支持。
