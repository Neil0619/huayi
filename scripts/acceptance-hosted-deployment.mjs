...
export function renderHostedDeploymentPlan() {
  return [
    ...
    "- The authorized recipient must use an unused email distinct from the existing First Operator account.",
    "- Account search must return zero exact matches before creating exactly one ordinary invitation.",
