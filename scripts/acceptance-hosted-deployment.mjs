...
export function renderHostedDeploymentPlan() {
  return [
    ...
    "- No Auth user, invitation, SMTP, DeepSeek, or kill-switch change occurred in the failed armed commit.",
    ...
    "- post-rotation exact-SHA API deployment -> disarm API -> corrected Sensitive Rotate",
    "- exact-source Dashboard redeploy while disarmed -> health -> non-writing database smoke",
    ...
    "- real R3-C delivery -> five Supabase Cron jobs",
